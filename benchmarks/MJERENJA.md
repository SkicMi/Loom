...
| 2026-09-26 20:10 | mascot-manny + WeaverMotion/motion_1790274564101.bvh | prsti Kimodo -> Manny: rotacija prsta prema roditelju prenesena u sustavu kosti (smjer kosti + normala dlana) umjesto svjetski | mjera=test_hand_rig: savijanje i rasirenost s predznakom (promjena od mirne poze), Manny prema SOMA, 672 uzorka, prije=T-poza 0.50 / 0.57 st; A-poza + dlan zakrenut 60 st: 8.1 / 16.0 st, poslije=T-poza 0.44 / 0.44 st; A-poza + zakrenut dlan 0.44 / 0.44 st, napomena=raniji ostatak od 7 st (fef29b1) bio je artefakt mjere: kut bez predznaka mijesa mirni bocni otklon sa savijanjem, odluka=zadrzano: prijenos prstiju ne ovisi o mirnoj pozi ruke |
| 2026-09-26 20:10 | mascot-03 (UniRig-52) | prsti na UniRig-52 nakon ispravka SOMA metakarpala: peace sign i hod (mvp_walk_wave_peace_roll) | mjera=test_unirig_fingers: ukupno savijanje prsta desne sake (dlan prema zadnjem clanku, st), prije=peace: kaziprst 50 srednji 48 prstenjak 95 mali 113; hod 23-37 st, do 35.5 st od (mirna poza + SOMA), poslije=peace: kaziprst 19 srednji 19 prstenjak 135 mali 150; hod 55-77 st, do 7.8 st od (mirna poza + SOMA), odluka=zadrzano: peace sign sad stvarno ispruzi dva prsta; hod vjerno prati SOMA preko mirne poze lika (bind je vec savijen 10-24 st) |
| 2026-09-26 22:19 | assets/characters/HumanoidMascott.glb -> tools/autorig/outputs/humanoid-mascott | izravni Manny rig bez UniRiga (tools/autorig/direct_rig.py) na novom HumanoidMascott (400k vrhova, A-poza) | mjera=skripta vrhova prstiju + test_grab_real + test_hand_rig, unirig=40 kostiju (3 prsta po saci) za seed 42/1/7 - manny_rig ga odbije, direct_vrijeme_s=49, unirig_vrijeme_s=~240, vrhovi_sake=427 -> ~6200, vrhovi_prsta_vezani_dalje_od_3cm=23.7 % -> 3.9 % (desna) / 5.7 % (lijeva), kosti_prstiju_bez_vrha=10/19 -> 4 (samo metakarpali, kao Manny), omatanje_mac_st=162 -> 175, vrhovi_od_drske_cm=<= 0.8, metakarpali_rasirenost_st=2.49 -> 0.66 (na pravcu zapesce - baza prsta), odluka=zadrzano: desni klik HumanoidMascott = humanoid-mascott; run.py --backend direct (zadano ostaje unirig) |

| 2026-09-27 | humanoid-mascott + WeaverMotion skok i points a gun | Kimodo -> Manny na A-poziranom liku: okret mirne kosti uda na smjer T-poze izvora (motionLimbRestAlignment) | mjera=test_manny_arms: najveci kut nadlaktice/podlaktice prema izvoru, prije=68 st (stalno u svakom kadru), poslije=skok 5 st, points a gun 8-9 st, odluka=zadrzano: retarget ne pretpostavlja T-pozu lika |
